...
for i in range(1,len(datos_elec)):
    ...
    repeating = (contador_elec[itemId[i]] > 1) & (tipo[i] == 'lecture')
    evaluating = (contador_elec[itemId[i]] > 1) & (tipo[i] == 'assessment')
    studyingTactics = ((tipo[i-1] == 'lecture') & (tipo[i] == 'assessment'))|((tipo[i] == 'lecture') & (tipo[i-1] == 'assessment'))
#    studyingTactics = studyingTactics & mismaSesion & mismoUser
    ...
    if(mismoUser & mismaSesion):
        if(repeating):
            ...
            actividad_log.append('REPEAT L')
            timestamp_log.append(timestamp[i]+1)
        if(evaluating):
            userId_log.append(userId[i])
            sesion_log.append(sesion[i])
            actividad_log.append('REPEAT A')
            timestamp_log.append(timestamp[i]+1)
        if(reading):
            userId_log.append(userId[i])
            sesion_log.append(sesion[i])
            actividad_log.append('LECTURE')
            timestamp_log.append(timestamp[i])
        if(elaboration):
            userId_log.append(userId[i])
            sesion_log.append(sesion[i])
            actividad_log.append('ASSESS')
            timestamp_log.append(timestamp[i])
        if(studyingTactics):
            userId_log.append(userId[i])
            sesion_log.append(sesion[i])
            actividad_log.append('PERFORM')
            timestamp_log.append(timestamp[i]-1)
    else:       
...
logSesionesSRL_elec['aprueba'] = logSesionesSRL_elec['aprueba'] == 1
...
logSesionesSRL_elec['curso'] = 'electrones_en_accion'
...
for i in range(1,len(datos_gestion)):
    ...
    repeating = (contador_gestion[itemId[i]] > 1) & (tipo[i] == 'lecture')
    evaluating = (contador_gestion[itemId[i]] > 1) & (tipo[i] == 'assessment')
    studyingTactics = ((tipo[i-1] == 'lecture') & (tipo[i] == 'assessment'))|((tipo[i] == 'lecture') & (tipo[i-1] == 'assessment'))
#    studyingTactics = studyingTactics & mismaSesion & mismoUser
    elaboration = actividad[i] == 'assessment.complete'
    reading = actividad[i] == 'lecture.complete'
...
logSesionesSRL_gestion['aprueba'] = logSesionesSRL_gestion['aprueba'] == 1
...
logSesionesSRL_gestion['curso'] = 'gestion_de_organizaciones'
...
for i in range(1,len(datos_aula)):
    ...
    repeating = (contador_aula[itemId[i]] > 1) & (tipo[i] == 'lecture')
    evaluating = (contador_aula[itemId[i]] > 1) & (tipo[i] == 'assessment')
    studyingTactics = ((tipo[i-1] == 'lecture') & (tipo[i] == 'assessment'))|((tipo[i] == 'lecture') & (tipo[i-1] == 'assessment'))
#    studyingTactics = studyingTactics & mismaSesion & mismoUser
    elaboration = actividad[i] == 'assessment.complete'
    reading = actividad[i] == 'lecture.complete'
...
logSesionesSRL_aula['aprueba'] = logSesionesSRL_aula['aprueba'] == 1
...
logSesionesSRL_aula['curso'] = 'aula_constructivista'
...
#logSesionesSRL_todo.to_csv('procesoSesionesSRL4.csv', index = False, columns = ['userId', 'sesion', 'timestamp', 'actividad', 'curso','aprueba', 'HighSRL'])
logSesionesSRL_todo.to_csv('procesoSesionesSRL4.csv', index = False)